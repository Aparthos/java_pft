...
public class ContactCreationTests {
  ...
  public void testContactCreationTests() throws Exception {
    ...
    fillContactForm(new ContactData("Kamil", "Malinowski", "Aparthos", "Mr.", "kamilmal7wp.pl@wp.pl"));
    submitContactCreation();
    returnToContactForm();
  }

  private void returnToContactForm() {
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("lastname")).sendKeys(contactData.surname());
